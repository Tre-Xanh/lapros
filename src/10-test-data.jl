...
n = 10*10^2 # number of samples

# ╔═╡ bef6e63d-205c-420a-b2f7-e9d45ef33c99
m = 3

# ╔═╡ cee22578-8f18-486c-97da-ad9bb416175e
lab_prefix = "la"
...
begin
	df = DataFrame();
	df.label = labels
	for i in 1:size(probas, 2)
		df[!, "$(lab_prefix)$(i)"] = probas[:, i]
	end
	df
end
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "d77d1289136052fc0cc71b88a2e6959021603712"
